                ...
                <table class="datatable table table-striped table-bordered dt-responsive nowrap table-search" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <tbody>
                        <?php foreach ($list as $key => $val) {
                            ...
                            echo "<td style='line-height: 0px !important; height:0px !important;'>$val->jenis_informasi</td>";
                            echo "<td style='line-height: 0px !important; height:0px !important;'>$val->judul_informasi</td>";
                            echo "<td style='line-height: 0px !important; height:0px !important;'><a href='" . base_url('assets/berkasi_ppid/') . $val->link . "' class='btn btn-primary btn-sm'>lihat file</a></td>";
                            echo "<td class='p-0 ps-1 pe-1' style='line-height: 0px !important; height: 0px !important;'>
                                    <button class='btn btn-danger btn-sm m-0 ' onclick='deleted(" . $val->kode . ")'>Delete</button>
                                </td>";
                            echo "</tr>";
                        } ?>
                    </tbody>
            ...
            <form id="form-data" enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="form-group">
                        <label for="exampleInputEmail1">Jenis Informasi</label>
                        <select class="form-control" name="jenis_informasi">
                            <option value="berkala">Informasi Berkala</option>
                            <option value="info-dikecualikan">Informasi Dikecualikan</option>
                            <option value="info-setiap-saat">Informasi Setiap Saat</option>
                            <option value="regulasi">Regulasi</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">Judul Informasi</label>
        ...
        Swal.fire({
            ...
            preConfirm: function() {
                return new Promise(function(resolve) {
                    $.ajax({
                        type: "post",
                        url: "<?= base_url("C_Informasi/delete") ?>",
                        data: {
                            'id': id
                        },
                        dataType: "json",
