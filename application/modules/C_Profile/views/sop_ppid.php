            ...
            <div class="card-body">
                ...
                <form id="form-data" enctype="multipart/form-data">
                    <div class="row">
                                ...
                                <tbody>
                                    <?php foreach ($list as $key => $item) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a target="_blank" href="<?= base_url('assets/berkas_ppid/' . $item->file) ?>" class="btn btn-danger btn-sm">Lihat File</a>
                                            </td>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                <label for="userfile" class="form-label">Description</label><br>
                                <input type="text" class="form-control" name="description" id="description">
                            </div>
                            <div class="mb-3">
                                <label for="userfile" class="form-label">Upload File</label><br>
...
<script>
    $(document).ready(function() {
        $('#uploadButton').click(function() {
            ...
            $.ajax({
                url: '<?php echo site_url("C_Profile/saveSOPPPID"); ?>',
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
