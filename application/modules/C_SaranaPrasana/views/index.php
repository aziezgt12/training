                ...
                <table class="datatable table table-striped table-bordered dt-responsive nowrap table-search" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <tbody>
                        <?php foreach ($list as $key => $val) {
                            ...
                            echo "<td style='line-height: 0px !important; height:0px !important;'><a class='btn btn-primary btn-sm' href='" . base_url('assets/berkas_ppid/') . $val->file . "' >Lihat File</a></td>";
        ...
        Swal.fire({
            ...
            preConfirm: function() {
                return new Promise(function(resolve) {
                    ...
                    $.ajax({
                        type: "post",
                        url: "<?= base_url("C_SaranaPrasana/save") ?>",
                        data: formData,
        ...
        Swal.fire({
            ...
            preConfirm: function() {
                return new Promise(function(resolve) {
                    $.ajax({
                        type: "post",
                        url: "<?= base_url("C_SaranaPrasana/delete") ?>",
                        data: {
                            'id': id
                        },
                        dataType: "json",
