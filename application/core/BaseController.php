...
class BaseController extends MX_Controller
{
    ...
    function stisla($template, $data = null)
    {
        ...
        $data['_stylesheet']      = $this->load->view('layout/_partial/stisla/stylesheet', $data, true);
        $data['_menu']       = $this->load->view('layout/_partial/stisla/menu', $data, true);
        $data['_navigation'] = $this->load->view('layout/_partial/stisla/navigation', $data, true);
        $data['_titlePage'] = isset($data['titlePage']) ? $data['titlePage'] : "";
        $data['_content']    = $this->load->view($template, $data, true);
        $data['_script']     = $this->load->view('layout/_partial/stisla/script', $data, true);
